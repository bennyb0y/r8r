...
export async function DELETE(
  ...
  try {
    ...
    console.log(`Proxying delete rating ${id} for tenant: ${tenant}`);
    
    // Forward to the worker with tenant information
    const workerUrl = `${process.env.API_BASE_URL}/ratings/${id}`;
    ...
    console.error('Error proxying rating deletion:', error);
